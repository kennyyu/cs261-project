...
Because of this exploratory analysis, we chose to implement Opsahl centralty and Ancestory centrality and analyze its accuracy on a real intrusion detection data set.
